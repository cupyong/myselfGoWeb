...
func (c *SQLiteConn) RegisterAggregator(name string, impl interface{}, pure bool) error {
	...
	// ai must outlast the databaseModel connection, or we'll have dangling pointers.
...
// SetTrace installs or removes the trace callback for the given databaseModel connection.
// It's not named 'RegisterTrace' because only one callback can be kept and called.
// Calling SetTrace a second time on same databaseModel connection
...
func (c *SQLiteConn) setSQLiteTrace(sqliteEventMask uint) error {
	...
	// passing the databaseModel connection handle as callback context.
